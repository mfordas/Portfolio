...
const PersonalData = () => {
  return (
    <div className='personalDataContainer'>
      ...
      <h3>JavaScript Developer / React Native</h3>
      <div className='linksIconsSocial'>
        <h2>
          <a href='https://fordas.pl/' rel='noopener noreferrer' target='_blank'>
            <TiHomeOutline />
          </a>
        </h2>
        <h2>
          <a href='https://github.com/mfordas' rel='noopener noreferrer' target='_blank'>
