    ...
    <div className='projectContainer'>
      ...
      <div className='linksIcons'>
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://candydefense.fordas.pl' rel='noopener noreferrer' target='_blank'>
              <TiHomeOutline />
            </a>
          </h2>
          <p>Home</p>
        ...
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/Candy_defense' rel='noopener noreferrer' target='_blank'>
              <TiSocialGithubCircular />
            </a>
          </h2>
          <p>Candy defense Github</p>
        </div>
      </div>
