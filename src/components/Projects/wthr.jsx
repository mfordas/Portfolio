    ...
    <div className='projectContainer'>
      ...
      <div className='linksIcons'>
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://wthr.fordas.pl' rel='noopener noreferrer' target='_blank'>
              <TiHomeOutline />
            </a>
          </h2>
          <p>Home</p>
        ...
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/Wthr' rel='noopener noreferrer' target='_blank'>
        ...
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/Wthr_mobile' rel='noopener noreferrer' target='_blank'>
              <TiSocialGithubCircular />
            </a>
          </h2>
          <p>Wthr Mobile Github</p>
        </div>
      </div>
