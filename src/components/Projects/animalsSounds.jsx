    ...
    return (
        <div className="projectContainer">
            ...
            <div className='linksIcons'>
                <div className="menuProjectIconContainer"><h2><a href='https://fordas.pl/animals_sounds/Animals_sounds' rel="noopener noreferrer" target='_blank'><TiHomeOutline /></a></h2><p>Home</p></div>
                <div className="menuProjectIconContainer"><h2><a href='https://github.com/mfordas/Animals_sounds' rel="noopener noreferrer" target='_blank'><TiSocialGithubCircular /></a></h2><p>Animals sounds Github</p></div>
            </div>
