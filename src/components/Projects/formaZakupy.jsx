...
const FormaZakupy = () => {
  return (
    <div className='projectContainer'>
      <h3>Forma zakupy</h3>
      <h4>
        Shopping aplication for Forma Dietetyk. Allows to create shopping lists and share them with family and friends.
        Application is created in two versions: web and mobile.
      </h4>
      <div className='linksIcons'>
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/forma_zakupy' rel='noopener noreferrer' target='_blank'>
              <TiSocialGithubCircular />
            </a>
          </h2>
          <p>Forma Zakupy Github</p>
        </div>
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/forma_zakupy_mobile' rel='noopener noreferrer' target='_blank'>
              <TiSocialGithubCircular />
            </a>
          </h2>
          <p>Forma Zakupy Mobile Github</p>
        </div>
      </div>
