...
const ProductDetective = () => {
  return (
    <div className='projectContainer'>
      ...
      <h4>
        Simple page for checking Nutrinion score of products. Page is based on Open Food Facts API and ZXing library for
        reading barcode of products
      </h4>
      <div className='linksIcons'>
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://productdetective.fordas.pl' rel='noopener noreferrer' target='_blank'>
              <TiHomeOutline />
            </a>
          </h2>
          <p>Home</p>
        ...
        <div className='menuProjectIconContainer'>
          <h2>
            <a href='https://github.com/mfordas/ProductDetective' rel='noopener noreferrer' target='_blank'>
              <TiSocialGithubCircular />
            </a>
          </h2>
          <p>Product Detective Github</p>
        </div>
      </div>
